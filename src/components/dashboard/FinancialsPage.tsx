...
function KPICard({ kpi }: { kpi: typeof financialKPIs[0] }) {
  ...
  // TradingView-style professional borders
  const borderColors = {
  ...
  // Subtle tinted backgrounds for icons (like Bloomberg Terminal)
  const iconBgColors = {
  ...
  return (
    <div className={`bg-white dark:bg-[#1A1D26] border ${borderColors[kpi.color as keyof typeof borderColors]} border-white/10 rounded-lg p-5 flex flex-col justify-between group hover:shadow-lg hover:border-white/20 transition-all duration-200`}>
      ...
      <div>
        <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-1">{kpi.titleAr || kpi.titleKey}</p>
...
function TabNavigation({ activeTab, setActiveTab }: { activeTab: FinanceTab; setActiveTab: (tab: FinanceTab) => void }) {
  ...
  return (
    <div className="bg-white dark:bg-[#1A1D26] border border-white/10 rounded-lg p-1 shadow-md flex gap-1 overflow-x-auto">
      {tabs.map((tab) => (
        <button 
          key={tab.id}
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Liquidity Metrics */}
        <div className="bg-white dark:bg-[#1A1D26] border border-white/10 rounded-lg p-5 shadow-md hover:border-white/20 transition-all">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl p-5 text-white shadow-xl">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-slate-50 dark:bg-white/[0.03] rounded-lg">
              ...
              <div className="flex justify-between items-center p-3 bg-slate-100 dark:bg-slate-800/70 rounded-lg mt-2">
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600">
            <Plus size={16} />
            New Entry
          </button>
      ...
      {/* Search and Filter */}
      <div className="bg-white dark:bg-[#1A1D26] border border-white/10 rounded-lg p-4 shadow-md">
      ...
      <div className="bg-white dark:bg-[#1A1D26] border border-white/10 rounded-lg shadow-md overflow-hidden">
        {/* Desktop Table View */}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          ...
          <div key={report.title} className="bg-white dark:bg-[#1A1D26] border border-white/10 rounded-lg p-5 shadow-md hover:border-white/20 transition-all hover:shadow-md transition-all cursor-pointer group">
...
function BudgetSection() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-500 rounded-lg p-6 shadow-sm">
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button className="px-4 py-2.5 rounded-lg border border-white/10 bg-white dark:bg-white/[0.05] text-slate-700 dark:text-slate-200 font-medium text-sm hover:bg-slate-50 dark:hover:bg-white/[0.08] transition-all flex items-center gap-2 shadow-md hover:border-white/20">
            <Download size={16} />
            Export
          </button>
          <button className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 text-white font-medium text-sm shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all flex items-center gap-2">
